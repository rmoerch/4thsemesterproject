...
public class RoomFirstDungeonGenerator : SimpleRandomWalkDungeonGenerator
{
    ...
    //This method picks a random room in our list of rooms and connects to the closest room center, then removes the current room from the list.
    ...
    private HashSet<Vector2Int> CreateCorridor(Vector2Int currentRoomCenter, Vector2Int destination)
    {
        ...
        //Next, we go right or left until we reach the value of x.
    ...
    {
        //For each point in our BoundsInt we create a position and add it to our floor HashSet.
        HashSet<Vector2Int> floor = new HashSet<Vector2Int>();

        //We loop through each room, so the HashSet ends up containing all floors for all rooms.
        foreach (var room in roomsList)
        {
